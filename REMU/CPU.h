...
private:
    ...
    virtual void exec_JAL(uint32_t inst);
    virtual void exec_JALR(uint32_t inst);
    virtual void exec_BEQ(uint32_t inst);
    virtual void exec_BNE(uint32_t inst);
    virtual void exec_BLT(uint32_t inst);
    virtual void exec_BGE(uint32_t inst);
    virtual void exec_BLTU(uint32_t inst);
    virtual void exec_BGEU(uint32_t inst);
    virtual void exec_LB(uint32_t inst);
    virtual void exec_LH(uint32_t inst);
    virtual void exec_LW(uint32_t inst);
    virtual void exec_LD(uint32_t inst);
    virtual void exec_LBU(uint32_t inst);
    virtual void exec_LHU(uint32_t inst);
    virtual void exec_LWU(uint32_t inst);
    virtual void exec_SB(uint32_t inst);
    virtual void exec_SH(uint32_t inst);
    virtual void exec_SW(uint32_t inst);
    virtual void exec_SD(uint32_t inst);
    virtual void exec_ADDI(uint32_t inst);
    virtual void exec_SLLI(uint32_t inst);
    virtual void exec_SLTI(uint32_t inst);
    virtual void exec_SLTIU(uint32_t inst);
    virtual void exec_XORI(uint32_t inst);
    virtual void exec_SRLI(uint32_t inst);
    virtual void exec_SRAI(uint32_t inst);
    virtual void exec_ORI(uint32_t inst);
    virtual void exec_ANDI(uint32_t inst);
    virtual void exec_ADD(uint32_t inst);
    virtual void exec_SUB(uint32_t inst);
    virtual void exec_SLL(uint32_t inst);
    virtual void exec_SLT(uint32_t inst);
    virtual void exec_SLTU(uint32_t inst);
    virtual void exec_XOR(uint32_t inst);
    virtual void exec_SRL(uint32_t inst);
    virtual void exec_SRA(uint32_t inst);
    ...
    virtual void exec_SRAIW(uint32_t inst);
    virtual void exec_ADDW(uint32_t inst);
    virtual void exec_MULW(uint32_t inst);
    virtual void exec_SUBW(uint32_t inst);
    virtual void exec_DIVW(uint32_t inst);
    virtual void exec_SLLW(uint32_t inst);
    virtual void exec_SRLW(uint32_t inst);
    virtual void exec_DIVUW(uint32_t inst);
    virtual void exec_SRAW(uint32_t inst);
    virtual void exec_REMW(uint32_t inst);
    virtual void exec_REMUW(uint32_t inst);
    virtual void exec_LR_W(uint32_t inst);
    virtual void exec_SC_W(uint32_t inst);
    virtual void exec_AMOSWAP_W(uint32_t inst);
    virtual void exec_AMOADD_W(uint32_t inst);
    virtual void exec_AMOXOR_W(uint32_t inst);
    virtual void exec_AMOAND_W(uint32_t inst);
    virtual void exec_AMOOR_W(uint32_t inst);
    virtual void exec_AMOMIN_W(uint32_t inst);
    virtual void exec_AMOMAX_W(uint32_t inst);
    virtual void exec_AMOMINU_W(uint32_t inst);
    virtual void exec_AMOMAXU_W(uint32_t inst);
    virtual void exec_LR_D(uint32_t inst);
    virtual void exec_SC_D(uint32_t inst);
    virtual void exec_AMOSWAP_D(uint32_t inst);
    virtual void exec_AMOADD_D(uint32_t inst);
    virtual void exec_AMOXOR_D(uint32_t inst);
    virtual void exec_AMOAND_D(uint32_t inst);
    virtual void exec_AMOOR_D(uint32_t inst);
    virtual void exec_AMOMIN_D(uint32_t inst);
    virtual void exec_AMOMAX_D(uint32_t inst);
    virtual void exec_AMOMINU_D(uint32_t inst);
    virtual void exec_AMOMAXU_D(uint32_t inst);
    virtual void exec_CSRRW(uint32_t inst);
    virtual void exec_CSRRS(uint32_t inst);
    virtual void exec_CSRRC(uint32_t inst);
